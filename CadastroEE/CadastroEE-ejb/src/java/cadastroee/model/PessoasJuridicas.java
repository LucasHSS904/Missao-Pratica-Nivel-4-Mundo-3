...
@NamedQueries({
    ...
    @NamedQuery(name = "PessoasJuridicas.findByIdPessoa", query = "SELECT p FROM PessoasJuridicas p WHERE p.idPessoa = :idPessoa"),
...
public class PessoasJuridicas implements Serializable {
    ...
    public PessoasJuridicas(Integer idPessoa) {
    ...
    public String toString() {
        return "cadastroee.model.PessoasJuridicas[ idPessoa=" + idPessoa + " ]";
    }

...
@NamedQueries({
    ...
    @NamedQuery(name = "PessoasFisicas.findByIdPessoa", query = "SELECT p FROM PessoasFisicas p WHERE p.idPessoa = :idPessoa"),
...
public class PessoasFisicas implements Serializable {
    ...
    public PessoasFisicas(Integer idPessoa) {
    ...
    public String toString() {
        return "cadastroee.model.PessoasFisicas[ idPessoa=" + idPessoa + " ]";
    }
